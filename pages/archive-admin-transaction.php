...
if (isset($_POST['transaction_id'])) {
    ...
    $update_query = "UPDATE tbltransaction SET archive = 0 WHERE id = ?";
  ...
  <?php
    ...
    <form method="POST" action="">
          <div class="search-bar">
            <label for="search">Search Tracking Number:</label>
            <input type="search" id="search" name="search" placeholder="Enter tracking number">
          </div>
    </form>
            ...
            while ($transaction_row = $transactions_result->fetch_assoc()) {
              ...
              echo "<td>
                      <form method='POST' action=''>
                          ...
                          <button type='submit' name='archive_button'>Unarchive</button>
                      </form>
                    </td>"; // Archive button
              echo "</tr>";
          }
